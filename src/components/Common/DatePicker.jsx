...
//     { label: "Last month", value: "lastmonth" },
//     { label: "This year", value: "thisyear" },
//     { label: "Custom", value: "custom" }, // Custom trigger
// ];
...
//             {/* Calendar Card */}
//             {showCalendar && (
//                 <Card className="relative border shadow-sm rounded-lg p-4 bg-white">
//                     {/* Close Button */}
//                     <button
...
//             {/* Selected Range Display */}
//             {dateRange.from && dateRange.to && (
//                 <Card className="border bg-gray-50 p-3 flex justify-between items-center">
