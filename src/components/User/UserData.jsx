...
//   const userPhotoURL = userPhoto?.startsWith("http") ? user.photo : null;
  ...
  return (
    <>
      {loading ? (
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
          {/* CHANGED: Reduced horizontal padding and adjusted max-width */}
          <div className="w-full mx-auto px-4 py-6">
            {/* CHANGED: Reduced gap from gap-8 to gap-6 */}
            <div className="flex flex-col lg:flex-row gap-6 items-stretch">
              {/* Sidebar - Fixed width on desktop */}
              <aside
                className="w-full lg:w-72 xl:w-80 flex-shrink-0 flex flex-col mb-6 lg:mb-0"
                ref={sidebarRef}
              >
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 flex-1 flex flex-col">
                  <div className="bg-gradient-to-r from-blue-700 to-blue-500 p-6 text-center rounded-t-2xl">
                    <div className="relative inline-block">
                      {userPhotoURL ? (
                        <img
                          src={
                        ...
                        <div className="relative w-20 h-20 rounded-full mx-auto mb-4 border-4 border-white shadow-lg bg-gray-100 flex items-center justify-center">
                        ...
                        >
                          <span
                            className={`text-lg transition-colors ${
                              menuItems.find((item) => item.to === to)?.isActive
                                ? "text-blue-600"
                                : "text-gray-500 group-hover:text-blue-600"
                            }`}
                          >
