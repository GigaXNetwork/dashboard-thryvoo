...
const ItemModal = ({
  ...
  useEffect(() => {
    if (mediaType !== 'none' || image || url || name) {
      setSubmitError('');
    }
  }, [mediaType, image, url, name]);
    ...
    try {
      ...
      if (mediaType === 'image' && imageFile) {
        ...
        payload = {
          url: url.trim(),
          type: 'video',
          name: name.trim() // Use the input name
        };
      }
        ...
        <form onSubmit={handleSubmitForm} className="flex-1 flex flex-col min-h-0">
          <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`p-2 h-11 border w-full rounded-md outline-none focus:ring-1 focus:ring-blue-600 ${
                  errors.name 
          ...
          <div className="flex justify-end gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50 flex-shrink-0">
            ...
            <button
              ...
              disabled={loading || !name.trim() || mediaType === 'none' ||
