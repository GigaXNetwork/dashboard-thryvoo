...
//                 openModal={() => setShowOfferForm(true)} // Changed to open OfferForm
    ...
    try {
      ...
      if (successCount > 0) {
        if (successCount === itemObj.length) {
          toast.success(`${successCount} coupon preset${successCount !== 1 ? 's' : ''} added successfully!`);
        } else {
          toast.success(`Added ${successCount} item${successCount !== 1 ? 's' : ''} successfully!`);
        }
