...
export default function CategorySec({ cardData, openModal, isExpanded = false }) {
  const category = cardData?.category || "--";

  return (
    <div className="w-full">
      <div className="flex items-center justify-between py-4 border-t border-gray-100 hover:bg-gray-50 transition-colors rounded-lg px-3">
        <div className="flex-1 flex items-center gap-6">
          <span className="text-gray-600 font-medium min-w-[120px]">Category</span>
